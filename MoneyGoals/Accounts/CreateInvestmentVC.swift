...
class CreateInvestmentVC: UIViewController {
    ...
    var investmentBalance: CurrencyField!
...
//        NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillShow), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    @objc func doneWithNumberPad() {
        ...
        let accountBalance = convertStringToCurrency(input: self.investmentBalance.text!)!
        
        
        let accountTuple = CoreDataManager.shared.createAccountInvestment(accountName: accountName, accountBroker: accountBroker, accountST: "Stock", accountBalance: accountBalance, accountNumber: accountNumber)
...
//        let height = view.bounds.size.height
    ...
    func setUI() {
        creditLabel = createLabel(string: "Manual Investmen", font: UIFont.font18, color: .black, alignment: .center)
        ...
        investmentBalance = createCurrencyField(placeholder: "0.00", font: UIFont.font22, alignment: .center)
        ...
        investmentBalance.inputAccessoryView = pickerToolBar
        ...
        view.addSubview(investmentBalance)
        investmentBalance.leadingAnchor.constraint(equalTo: margin.leadingAnchor).isActive = true
        investmentBalance.trailingAnchor.constraint(equalTo: margin.trailingAnchor).isActive = true
        investmentBalance.topAnchor.constraint(equalTo: accountText.bottomAnchor, constant: 10).isActive = true
        investmentBalance.heightAnchor.constraint(equalToConstant: 20).isActive = true
        ...
        accountNumber.topAnchor.constraint(equalTo: investmentBalance.bottomAnchor, constant: 10).isActive = true
