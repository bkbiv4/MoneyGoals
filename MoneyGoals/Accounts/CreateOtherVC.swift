...
class CreateOtherVC: UIViewController {
...
//        NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillShow), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    @objc func doneWithNumberPad() {
        ...
        let accountTuple = CoreDataManager.shared.createAccountOther(accountName: accountName, accountBroker: accountBroker, accountST: "Other", accountBalance: accountBalance, accountNumber: accountNumber)
